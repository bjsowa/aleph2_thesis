...
\begin{itemize}
	\item TODO % incompatible ROS API - controller manager
	\item TODO % controllers for additional functionalities
	\item TODO % Nanotec only velocity interface
	\item TODO % joint mode controller
	\item TODO % separate joint specification
	\item TODO % joints and actuators separation
\end{itemize}
