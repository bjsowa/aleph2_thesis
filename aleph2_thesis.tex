...
\section{Overview of provided packages}
    ...
    \begin{itemize}
        ...
        contains a C++ library that utilizes \textsf{kacanopen} to provide an interface for communication with Nanotec motor drivers which are used extensively on the \rovername robot.
        \item \href{https://github.com/acriaer/rubi_server}{\textbf{rubi\_server}} -- 
        contains the server node for communication with RUBI-enabled boards and message definitions for the ROS side of the protocol.
    \end{itemize}
    ...
    \dirtree{%
        .1 aleph2\_description/.
            ...
            \filedesc{urdf files}.
                ...
                \filedesc{gazebo references}.
                .3 manip.urdf.xacro.
                .3 zed.urdf.xacro.
                .3 materials.urdf.xacro.
                .3 aleph2.urdf
                \filedesc{An output urdf file generated from xacro files}.
            .2 rviz/ 
