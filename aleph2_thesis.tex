...
\section{Overview of provided packages}
	...
	\begin{itemize}
		\item \href{https://gitlab.continuum.ii.uni.wroc.pl/continuum/software/kacanopen}{\val{kacapopen}} -- 
		...
		\item \href{https://gitlab.continuum.ii.uni.wroc.pl/continuum/software/nanotec_driver}{\val{nanotec\_driver}} -- 
		...
		\item \href{https://github.com/acriaer/rubi_server}{\val{rubi\_server}} -- 
		...
		\item \href{https://gitlab.continuum.ii.uni.wroc.pl/continuum/software/messages/tree/master/power_msgs}{\val{power\_msgs}} -- contains the \textsf{PowerStatus} message definition that is used by the \textsf{power\_monitor} node.
	\end{itemize}
...
TODO
	...
	\subsection{Nodes}
		\begin{itemize}
			\item \textbf{\textsf{power\_monitor}}\\
			...
			\item \textbf{\textsf{rosbag\_recorder}}\\
